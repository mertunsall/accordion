# inspired from https://github.com/ra1ph2/Vision-Transformer/blob/main/VisionTransformer.ipynb
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, embed_dim, heads=8, activation=None, forward_expansion=1, dropout=0.1):
        ...
        self.adaptable_parameters = self.total_parameters 
...
class AdaptableVisionTransformer(nn.Module):
    '''
    ...
    def __init__(self, patch_size, max_len, embed_dim, classes, layers, channels=3, heads=8, activation=None, forward_expansion=1, dropout=0.1):
        super(AdaptableVisionTransformer, self).__init__()
        self.name = 'AdaptableVisionTransformer'
        ...
        self.layers = self.transformer.trans_blocks
        
        self.active_blocks = 0
        for layer in self.layers:
            self.num_adaptable_params += layer.adaptable_parameters
    ...
    def reconfigure_blocks(self, num_blocks: int):
        ...
        for layer in self.layers:
            if self.active_blocks < num_blocks:
                layer.active = True
                self.active_blocks += 1
                num_active_params += layer.adaptable_parameters
            else:
    ...
    def print_active_blocks(self) -> None:
        ...
        for i, layer in enumerate(self.layers):
            if layer.active:
                print(f"Layer {i} is active with {layer.total_parameters} parameters.")
